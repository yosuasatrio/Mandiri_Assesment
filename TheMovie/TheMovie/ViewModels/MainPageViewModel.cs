...
namespace TheMovie.ViewModels
{
    ...
    {        
        ...
        //public DelegateCommand ShowSearchMoviesByGenreCommand { get; }
        ...
        public MainPageViewModel(INavigationService navigationService)
        {
            ...
            //ShowSearchMoviesByGenreCommand = new DelegateCommand(async () => await ExecuteShowSearchMoviesByGenreCommand().ConfigureAwait(false));
        ...
        private async Task ExecuteShowSearchMoviesByGenreCommand()
        {
            await navigationService.NavigateAsync("SearchMoviesByGenrePage").ConfigureAwait(false);
        }
    ...
    public class GetGenreDropDownModel : BaseViewModel
    {
        public ObservableCollection<Genre> genreLists { get; set; }

        public GetGenreDropDownModel()
        {
            Task<List<Genre>> task = ApiService.GetGenreDropDown();

            genreLists = new ObservableCollection<Genre>(task.Result);
